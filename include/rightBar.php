<div class="right">
    <div class="request">
        ...
        <div class="new-requests">
            ...
            <button class=" btn btn-primary" name="confirm" type='submit' value=<?php echo $last_requested_user_id; ?>>Confirm </button>
            <button class=" btn btn-primary" name="Delete" type='submit' value=<?php echo $last_requested_user_id; ?>>Delete</button>
            </form>  
        </div>
        </div>
    </div>
